...
//      }
//    }
      std::string iconDir = "C:/workspace/CaPTk/data/icons/";
    ...
    //changeButton->setSizePolicy(sp);
    changeButton->setFixedWidth(constButtonWidth20);
    int btnWidth = changeButton->width();
    //changeButton->setFixedWidth(100);
    qDebug() << " change button width = " << btnWidth << endl;
    ...
    //changeOldValues->adjustSize();
    qDebug() << " old values button width = " << changeOldValues->width() << endl;
    //changeOldValues->setSizePolicy(sp);
    ...
    //changeNewValues->setSizePolicy(sp);
    changeNewValues->setFixedWidth(constButtonWidth20);
    qDebug() << " new values button width = " << changeNewValues->width() << endl;
